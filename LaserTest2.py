...
#########################################
# constants
SPEED = 20  # pixel/s random speed for now
WIDTH_OF_CAR = 40  # pixels random width (back wheel to back wheel)
HUE_MIN = 20
HUE_MAX = 160
SAT_MIN = 100
SAT_MAX = 255
...
start = (0, 0) #starting position of the robot, might need to change.
orientation = (0, 1)
